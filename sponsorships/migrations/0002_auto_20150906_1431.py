    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='sponsorship_creator', to=settings.AUTH_USER_MODEL, null=True)),
                ('invoice', models.ForeignKey(blank=True, to='invoices.Invoice', null=True)),
                ('owner', models.ForeignKey(related_name='sponsorship_owner', to=settings.AUTH_USER_MODEL, null=True)),
